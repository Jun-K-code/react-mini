...
function siftDown(heap, node, i) {
  let index = i; // 记录任务的下标，也是从 0 开始的
  let len = heap.length; // 当前任务队列的长度
